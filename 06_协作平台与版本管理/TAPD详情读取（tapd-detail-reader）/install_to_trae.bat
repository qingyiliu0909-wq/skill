...
echo ========================================
echo   Install Skills to Trae: %SKILL_CATEGORY%
echo ========================================
echo.
...
for /f "tokens=1,2 delims==" %%A in ('findstr "TRAE_SKILLS_PATH" "%SKILL_DIR%\paths.md"') do (
    set "TARGET_DIR=%PROJECT_ROOT%\%%B"
)

if not defined TARGET_DIR (
    echo ERROR: TRAE_SKILLS_PATH not found in paths.md
    exit /b 1
)
